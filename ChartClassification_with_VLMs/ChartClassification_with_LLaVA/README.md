...
This code is provided for research and educational purposes only. The LLaVA models are governed by the license specified in their original repository. When using this code with LLaVA models, you must comply with their licensing terms.
